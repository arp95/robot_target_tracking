...
mean_1 = np.asarray([4, 16])
x_true_1 = 4
y_true_1 = 16
var_1 = [[1, 0], [0, 1]]
init_pos_1 = [2, 16]
mean_2 = np.asarray([16, 4])
x_true_2 = 16
y_true_2 = 4
var_2 = [[1, 0], [0, 1]]
init_pos_2 = [14, 4]
...
for t in range(2, 200):
    ...
    target_x_mean_1, target_y_mean_1, var_1, x_true_1, y_true_1 = extended_kalman_filter(mean_1[0], mean_1[1], var_1, robots_x, robots_y, robots_id, t, init_pos_1[0], init_pos_1[1])
    mean_1 = np.asarray([target_x_mean_1, target_y_mean_1])
    target_x_mean_2, target_y_mean_2, var_2, x_true_2, y_true_2 = extended_kalman_filter(mean_2[0], mean_2[1], var_2, robots_x, robots_y, robots_id, t, init_pos_2[0], init_pos_2[1])
    ...
    net_val += -np.log(np.linalg.det(var_1)) - np.log(np.linalg.det(var_2))
    prev_robot_x = robots_x[0]
    prev_robot_y = robots_y[0]
